...
echo '<link href="../hw10/assets/css/style.css" rel="stylesheet" type="text/css">';
echo '<link href="../hw10/assets/css/bootstrap.css" rel="stylesheet" type="text/css">';
echo '</head>';
echo '<body>';

echo '<div class="banner"><h1>Contact</h1></div>';
echo '<div class="tabs">';
echo '<a href="/hw10/index.php"><div class="col-sm-3 navItem">Home</div></a>';
echo '<a href="/hw10/school.php"><div class="col-sm-3 navItem">School</div>';
echo '<a href="/hw10/work.php"><div class="col-sm-3 navItem">Work</div></a>';
